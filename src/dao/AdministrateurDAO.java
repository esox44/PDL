...
public class AdministrateurDAO extends ConnectionDAO {
	...
	*/
	 ...
	 */
	public ArrayList<Administrateur> getList() {
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		...
		try {
			...
			while (rs.next()) {
				returnValue.add(new Administrateur(rs.getInt("idAdministrateur"),
					       rs.getString("nom"),
					       rs.getString("prenom"),
					       rs.getString("identifiantConnexion"),
					       rs.getString("motDePasse")));
	...
	public static void main(String[] args) throws SQLException {
		...
		Administrateur administrateur = new Administrateur("Maxime","Blanchard","26","26");
